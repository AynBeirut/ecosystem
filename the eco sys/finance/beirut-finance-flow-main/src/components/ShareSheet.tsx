        ...
        <div className="px-4 pb-6 pt-2 space-y-1">
          ...
          >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  {mobile ? 'Download PDF then open WhatsApp' : 'Download PDF and open WhatsApp Web'}
                </p>
              </div>
            </button>
          ...
          >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  {mobile ? 'Download PDF then open your email app' : 'Download PDF and open your email client'}
                </p>
              </div>
            </button>
        </div>
