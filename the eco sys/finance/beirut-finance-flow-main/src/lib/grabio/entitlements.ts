...
/** Alias — matches main Grabio platform `canUseInvoiceManagerApp`. */
export function canUseInvoiceManagerApp(profile: GrabioStoreProfile | null | undefined): boolean {
  return canUseInvoiceModule(profile);
}
