...
Last updated: 2026-04-27 (AI roadmap moved, GDPR removed, P2 SSL auto-provisioning + Square + OMT + BOB + Whish ops checklist + auto currency rates + split payments + refund management workflow + modern minimalist theme completed)
...
- [ ] Classic e-commerce theme (`Size: 3 MB`, `Best: after minimalist theme done`)
