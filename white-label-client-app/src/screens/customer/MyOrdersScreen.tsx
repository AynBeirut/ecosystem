...
type MyOrdersRouteProp = RouteProp<{ MyOrders: { orderId?: string } }, 'MyOrders'>;
...
export default function MyOrdersScreen() {
  ...
  // Auto-trigger lookup if opened via deep link with orderId
  useEffect(() => {
    const deepLinkOrderId = route.params?.orderId;
    if (deepLinkOrderId) {
      navigation.navigate('OrderTracking', { orderId: deepLinkOrderId });
    }
