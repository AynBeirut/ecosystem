...
export const PLATFORM_STATIC_SITEMAP: PlatformSitemapEntry[] = [
  ...
  { path: '/demo/shop', priority: '0.92', changefreq: 'weekly' },
  { path: '/demo/cafe', priority: '0.92', changefreq: 'weekly' },
  { path: '/demo/restaurant', priority: '0.92', changefreq: 'weekly' },
  { path: '/demo/manufacturing', priority: '0.92', changefreq: 'weekly' },
  { path: '/demo/ecommerce', priority: '0.92', changefreq: 'weekly' },
