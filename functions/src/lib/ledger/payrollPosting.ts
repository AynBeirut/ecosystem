...
import { ensureEmployeeComponentAccount } from './employeeSubaccountLedger';
import { GL_ACCOUNT_CODES } from './defaultChartOfAccounts';
import { type JournalLineInput, type LedgerAccount } from './postingService';
...
export function payrollCashOrBank(paymentMethod?: string): string {
