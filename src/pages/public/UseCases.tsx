...
const USE_CASES = [
  {
    ...
    features: [
      ...
      'Grabio POS (Windows + mobile) included across packages',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Grabio POS for counter checkout',
    ],
  ...
  },
  {
    ...
    description:
      'Consultancies and service businesses use invoicing, Service Subscriptions (beta), Sales CRM, Projects (PSA), and Proposal Writer inside one account.',
    features: [
      'Service-type products and recurring billing',
      'Quote-to-invoice workflows',
      'Sales CRM add-on — pipeline and reps',
      'Projects (PSA) — client and grant portals',
      'AI Proposal Writer — client and donor proposals',
  ...
  },
  {
    ...
    features: [
      ...
      'Factory Flow package with POS and admin app included',
      'Marketplace and invoicing included',
      'Business Insights AI for plain-language analytics',
    ],
