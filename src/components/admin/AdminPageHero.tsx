...
export default function AdminPageHero({
  ...
  return (
    <section className="relative mb-8 -mx-4 sm:mx-0 rounded-none sm:rounded-2xl bg-[#0b1220] text-white py-8 md:py-10 px-4 sm:px-8 overflow-hidden">
      <div
      ...
      <div className="relative">
        ...
        {description && <p className="text-sm md:text-base text-slate-300 max-w-2xl">{description}</p>}
        <div className="mt-4">
